...
export const BLOCKS = {
	...
	"lava3": { size: [4, 4, 0], pos: [416, 384], dim: [64, 64], options: { blendLevel: 2, sprites: 2, hideInEditor: true  } },
	...
	"ceiling.4x6": { size: [4, 6, 1], pos: [640, 192], dim: [80, 88], options: { sprites: 2, roof: true } },
	"ceiling.6x4": { size: [6, 4, 1], pos: [768, 192], dim: [80, 88], options: { sprites: 2, roof: true } },
	"ceiling.6x2": { size: [6, 2, 1], pos: [864, 192], dim: [64, 72], options: { sprites: 2, roof: true } },
	"ceiling.2x6": { size: [2, 6, 1], pos: [944, 192], dim: [64, 72], options: { sprites: 2, roof: true } },

...
import * as URGIL_CONVO from "../convo/urgil"
...
export const LEVELS = {
	...
	urgil_cave: {
		...
		connect: [
            {
                src: { x: 116, y: 1, z: 0 },
                dst: { map: "urgil", x: 116, y: 84, dir: "s" }
            }
		],
        generators: [
            { x: 130, y: 31, z: 0, type: MONSTERS.goblin, count: 3 },
            { x: 76, y: 18, z: 0, type: MONSTERS.goblin, count: 3 },
            { x: 16, y: 45, z: 0, type: MONSTERS.goblin, count: 3 },
            { x: 14, y: 4, z: 0, type: MONSTERS.goblin, count: 3 },
            { x: 1, y: 65, z: 0, type: MONSTERS.goblin, count: 3 },
            { x: 37, y: 122, z: 0, type: MONSTERS.goblin, count: 3 },
            { x: 10, y: 126, z: 0, type: MONSTERS.goblin, count: 3 },
            { x: 66, y: 78, z: 0, type: MONSTERS.goblin, count: 3 },
            { x: 121, y: 97, z: 0, type: MONSTERS.goblin, count: 3 },
            { x: 137, y: 70, z: 0, type: MONSTERS.goblin, count: 3 },
            { x: 89, y: 142, z: 0, type: MONSTERS.goblin, count: 3 },
        ],
        monsters: [
            { monster: MONSTERS.ogre, pos: [ [91, 66] ],
				onDeath: (arkona) => {
					// start convo
	...
	urgil: {
		...
		connect: [
            ...
            {
                src: { x: 116, y: 80, z: 0 },
                dst: { map: "urgil_cave", x: 116, y: 4, dir: "s" },
                test: (arkona) => arkona.gameState["QUEST_URGIL"]
            }
		],
        npcs: [
            { creature: "cow", x: 86, y: 100, options: { convo: FARM_CONVO.COW } },
            { creature: "cow", x: 92, y: 93, options: { convo: FARM_CONVO.COW } },
            { creature: "goblin", x: 134, y: 122, options: { movement: MOVE_ANCHOR, name: "Mgrum", convo: URGIL_CONVO.COMMON } },
            { creature: "goblin", x: 125, y: 147, options: { movement: MOVE_ANCHOR, name: "Drruk", convo: URGIL_CONVO.COMMON } },
            { creature: "goblin", x: 140, y: 141, options: { movement: MOVE_ANCHOR, name: "Grenm", convo: URGIL_CONVO.COMMON } },
            { creature: "goblin", x: 103, y: 127, options: { movement: MOVE_ANCHOR, name: "Mrigh", convo: URGIL_CONVO.COMMON } },
            { creature: "goblin", x: 110, y: 102, options: { movement: MOVE_ANCHOR, name: "Bhurr", convo: URGIL_CONVO.COMMON } },
            { creature: "ogre", x: 105, y: 105, z: 1, options: { movement: MOVE_ANCHOR, name: "King Urgil", convo: URGIL_CONVO.UGRIL } },
            { creature: "goblin", x: 92, y: 126, options: { movement: MOVE_ANCHOR, name: "Gopr", convo: URGIL_CONVO.COMMON } },
            { creature: "goblin", x: 80, y: 139, options: { movement: MOVE_ANCHOR, name: "Gharr", convo: URGIL_CONVO.COMMON } },
            { creature: "goblin", x: 114, y: 85, options: { movement: MOVE_ANCHOR, name: "Kthip", convo: URGIL_CONVO.COMMON } },
        ],
        onLoad: arkona => {
			if(arkona.gameState["QUEST_URGIL"] == true) {
				// remove the king
				arkona.level.removeNpcByName("King Urgil")
				// turn goblins hostile
				arkona.level.turnHostileByName([ "Mgrum", "Drruk", "Grenm", "Mrigh", "Bhurr", "Gopr", "Gharr", "Kthip" ])
			}
		},
	},
	voln: {
